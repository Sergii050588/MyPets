...
A `POST` request is used to create an pet

==== Example curl request

include::{snippets}/create-pet/curl-request.adoc[]
...
include::{snippets}/create-pet/links.adoc[]
...
include::{snippets}/publish-pet/curl-request.adoc[]

==== Example HTTP request

include::{snippets}/publish-pet/http-request.adoc[]

==== Example response

include::{snippets}/publish-pet/http-response.adoc[]

==== Links

include::{snippets}/publish-pet/links.adoc[]

==== Response Fields

include::{snippets}/publish-pet/response-fields.adoc[]
